defmodule RecipePerTestWeb.UserAuthTest do
  use RecipePerTestWeb.ConnCase, async: true

  alias RecipePerTest.Accounts
  alias RecipePerTestWeb.UserAuth
  import RecipePerTest.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, RecipePerTestWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      RecipePerTestWeb.Endpoint.subscribe(live_socket_id)

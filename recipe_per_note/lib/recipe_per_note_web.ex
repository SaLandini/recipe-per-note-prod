defmodule RecipePerNoteWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: RecipePerNoteWeb

      import Plug.Conn
      import RecipePerNoteWeb.Gettext
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/recipe_per_note_web/templates",
        namespace: RecipePerNoteWeb
  ...
  defp view_helpers do
    quote do
      ...
      import RecipePerNoteWeb.ErrorHelpers
      import RecipePerNoteWeb.Gettext
      alias RecipePerNoteWeb.Router.Helpers, as: Routes
    end
  end

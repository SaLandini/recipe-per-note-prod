defmodule RecipePerTest.Accounts.User do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, RecipePerTest.Repo)
  ...
  """
  def valid_password?(%RecipePerTest.Accounts.User{hashed_password: hashed_password}, password)
